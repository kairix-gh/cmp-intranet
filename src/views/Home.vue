<template>
    <div class="">
        <div class="flex flex-col mx-4">
            ...
            <router-link :to="{ name: 'News'}" class="inline-flex items-center mt-4 uppercase text-white text-sm font-medium bg-blue-300 rounded px-2.5 py-1 hover:bg-blue-600 w-full md:w-auto justify-center md:self-end">
                See All News
